...
/* harmony import */ var _start_game_options_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./start-game-options.component */ "./src/app/start-game-options/start-game-options.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: _start_game_options_component__WEBPACK_IMPORTED_MODULE_2__["StartGameOptionsComponent"] }
];
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_http_start_game_options_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/http-start-game-options.service */ "./src/app/services/http-start-game-options.service.ts");
/* harmony import */ var _models_request_game_start_options_game_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/request-game-start-options-game.model */ "./src/app/models/request-game-start-options-game.model.ts");
/* harmony import */ var _services_http_game_process_servise__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/http-game-process.servise */ "./src/app/services/http-game-process.servise.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StartGameOptionsComponent = /** @class */ (function () {
    function StartGameOptionsComponent(service) {
        ...
        this.opened = true;
        this.reqModel = new _models_request_game_start_options_game_model__WEBPACK_IMPORTED_MODULE_2__["RequestGameStartOptionsView"]();
    }
    ...
    StartGameOptionsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_services_http_start_game_options_service__WEBPACK_IMPORTED_MODULE_1__["HttpStartGameOptionsService"], _services_http_game_process_servise__WEBPACK_IMPORTED_MODULE_3__["HttpGameProcessService"]]
        }),
        __metadata("design:paramtypes", [_services_http_start_game_options_service__WEBPACK_IMPORTED_MODULE_1__["HttpStartGameOptionsService"]])
...
/* harmony import */ var _start_game_options_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./start-game-options-routing.module */ "./src/app/start-game-options/start-game-options-routing.module.ts");
/* harmony import */ var _start_game_options_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./start-game-options.component */ "./src/app/start-game-options/start-game-options.component.ts");
...
/* harmony import */ var _game_process_game_process_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../game-process/game-process.component */ "./src/app/game-process/game-process.component.ts");
    ...
    StartGameOptionsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _start_game_options_routing_module__WEBPACK_IMPORTED_MODULE_2__["StartGameOptionsRoutingModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"],
                _progress_kendo_angular_dropdowns__WEBPACK_IMPORTED_MODULE_5__["DropDownsModule"],
                _progress_kendo_angular_dialog__WEBPACK_IMPORTED_MODULE_6__["WindowModule"],
                _progress_kendo_angular_buttons__WEBPACK_IMPORTED_MODULE_7__["ButtonsModule"],
                _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"]
            ],
            declarations: [_start_game_options_component__WEBPACK_IMPORTED_MODULE_3__["StartGameOptionsComponent"], _game_process_game_process_component__WEBPACK_IMPORTED_MODULE_8__["GameProcessComponent"]]
        })
