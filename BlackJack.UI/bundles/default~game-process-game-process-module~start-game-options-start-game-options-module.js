...
var GameProcessComponent = /** @class */ (function () {
    function GameProcessComponent(service) {
        ...
        this.getCardModel = new _models_requestModels_request_get_card_game_view__WEBPACK_IMPORTED_MODULE_3__["RequestGetCardGameView"]();
    }
    ...
    GameProcessComponent.prototype.getCardClick = function () {
        ...
        this.service.HttpGetCard(this.getCardModel)
            .subscribe(function (data) { return _this.model.Player.PlayerRoundHand = data.Hand; });
    };
    __decorate([
